...
class DzRandomCastleFillerCog(commands.Cog):
    ...
    @nextcord.slash_command(name='dz_choose_castle_fillers', description='Wählt zufällig Mitglieder aus, die mit "Ja" reagiert haben')
...
def setup(bot):
    bot.add_cog(DzRandomCastleFillerCog(bot))