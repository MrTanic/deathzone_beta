...
import pytz
from bot.setup.discord.channel_ids import UT_CWL_CHANNEL, STATUS_CHANNEL_ID
from bot.setup.discord.user_ids import UTOPIA_ROLE_ID

class UtCWLTask(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.announcement_channel_id = UT_CWL_CHANNEL
    ...
    async def auto_announce(self):
        ...
        if now.day == 18 and now.hour == 20 and now.minute == 25:
