...
os.makedirs('datenbank/umfrage/academy', exist_ok=True)

# Pfad zur Datenbankdatei
db_path = os.path.join('datenbank', 'umfrage', 'academy', 'ac_cwl_umfrage.db')
...
def setup_database():
    ...
    cursor.execute('''
    CREATE TABLE IF NOT EXISTS ac_cwl_umfragen (
