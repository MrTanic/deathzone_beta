...
os.makedirs('datenbank/umfrage/immortality', exist_ok=True)

# Pfad zur Datenbankdatei
db_path = os.path.join('datenbank', 'umfrage', 'immortality', 'im_cwl_umfrage.db')
...
def setup_database():
    ...
    cursor.execute('''
    CREATE TABLE IF NOT EXISTS im_cwl_umfragen (
