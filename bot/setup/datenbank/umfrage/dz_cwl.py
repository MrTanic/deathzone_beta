...
os.makedirs('datenbank/umfrage/deathzone', exist_ok=True)

# Pfad zur Datenbankdatei
db_path = os.path.join('datenbank', 'umfrage', 'deathzone', 'dz_cwl_umfrage.db')
...
def setup_database():
    ...
    cursor.execute('''
    CREATE TABLE IF NOT EXISTS cwl_umfragen (
